...
export const networks: Record<NetworkId, NetworkConfig> = {
  ethereum: {
    ...
    nomadUrl: "https://nomad.mirageprivacy.com",
  ...
  sepolia: {
    ...
    nomadUrl: "https://nomad-sepolia.mirageprivacy.com",
    apiServer: "https://api-sepolia.mirageprivacy.com",
    enableCompliance: true,
    enableBatch: false,
  ...
  tempo: {
    ...
    kind: "tempo",
    chainId: 42431,
    rpcUrl: "https://rpc.tempo.mirageprivacy.com",
    nomadUrl: "https://nomad-tempo.mirageprivacy.com",
    apiServer: "https://api-tempo.mirageprivacy.com",
